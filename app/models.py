...
class User(db.Model,UserMixin):
    ...
    encrypted_password =db.Column(db.String(105), nullable=False)
...
class Task(db.Model):
    ...
    create_at = db.Column = db.Column(db.DateTime, default=datetime.datetime.now())
    @property
    ...
    @classmethod
    def update_element(cls,task_id,title,description):
